...
P003B.ii — Replication of Stahlman, Young, & Blaisdell (2010) Pavlovian task.
Six conditioned stimuli (CS) — A,B,C,D,E,F — each signal a fixed probability
of reward delivery that is independent of responding (pure Pavlovian).
Probabilities: A=1.000, B=0.353, C=0.125, D=0.044, E=0.011, F=0.006.
Each CS is presented 9 times per session (54 total trials); no CS appears more
than three times consecutively. Each trial lasts 10 s; the inter-trial interval
(ITI) is 60 s. Pecks on and off the cue are recorded for spatial/temporal
behavioral analyses, but they do not influence trial outcomes.

Stimuli are PNGs named A.png–F.png located in the script’s ./stimuli/ folder.
Per-subject stimulus filename assignments are read from
“P003B.ii_stimulus_assignments.csv” in the same folder as this script.
"""
...
class ExperimenterControlPanel(object):
    ...
    def __init__(self):
        ...
        self.control_window.title("P003B.ii Control Panel")
        ...
        # (P003B.ii) No phases/conditions — removed condition menu.
...
class MainScreen(object):
    ...
    def __init__(self, subject_ID, record_data, data_folder_directory):
        ...
        self.root = Toplevel() 
        self.root.title("P003B.ii: Pavlovian Response Variability")
        ...
        self.prob_columns = ["100", "35.3", "12.5", "4.4", "1.1", "0.6"]
    ...
    def place_birds_in_box(self):
        ...
        def first_ITI(event):
            ...
            csv_path = os_path.join(script_dir, "P003B.ii_stimulus_assignments.csv")
            ...
            potential_trial_assignments = all_trial_types * 9
