...
@author: Cyrus K. & Megan C.

This project investigated the roles of various scedules of reinforcement 
(Pavlovian, instrumental, omission, and extinction contingencies) in dictating 
spatial and temoporal response variability. It also accounted for proximity to
reinforcement by modifying the number of responses to reach each trial's
outcome; this manipulation occured each phase.

All subjects underwent a single phase consisting of stimuli defined by 
RR2, RR5, and RR20 reward contingencies. Across each session of each phase, 
trials could be one of four types (the reinforcement schedules described 
above), differentiated by stimulus color--eight distinct colors were
counter-balanced across four groups of twelve subjects. 
...
class MainScreen(object):
    ...
    def __init__(self, subject_ID, record_data, data_folder_directory):
        ...
        header_list = ["SessionTime", "Xcord","Ycord", "Event", "TrialTime", 
                       ...
                       "TrialNum", "TrialColor", "Subject", "HiddenPatch",
                       "Date"] # Column headers
